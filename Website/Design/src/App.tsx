  ...
  return (
    <nav className={`nav ${scrolled ? 'nav-scrolled' : ''}`}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 60 }}>
        ...
        {/* Mobile menu button */}
        <button className="hide-tablet" onClick={() => setMenuOpen(!menuOpen)} style={{ background: 'none', border: 'none', color: 'var(--text)', cursor: 'pointer', padding: 4 }} aria-label="Menu">
...
function Hero() {
  return (
    <section id="product" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingTop: 80, paddingBottom: 60 }}>
    ...
    <section id="capabilities" ref={ref} className="section" style={{ borderTop: '1px solid var(--border)', background: 'linear-gradient(180deg, var(--surface) 0%, var(--bg) 100%)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div className="reveal reveal-d1 product-window">
          ...
          <div style={{ overflowX: 'auto', borderBottom: '1px solid var(--border)' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 900 }}>
              <thead>
                <tr>
                  {['No.', 'Time', 'PID', 'Process', 'Source', 'Destination', 'Proto', 'Len', 'MITRE', 'Severity', 'Info'].map(h => (
                    <th key={h} style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, color: 'var(--dim)', letterSpacing: '0.08em', textTransform: 'uppercase', padding: '7px 10px', textAlign: 'left', borderBottom: '1px solid var(--border-mid)', whiteSpace: 'nowrap' }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr 260px', minHeight: 340 }}>
            {/* Left: Process info */}
...
function MitreSection() {
  ...
  return (
    <section ref={ref} className="section" style={{ borderTop: '1px solid var(--border)', background: 'var(--surface)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
        <div className="reveal" style={{ marginBottom: 56 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, alignItems: 'stretch' }} className="stack-mobile">
          ...
          <div className="reveal reveal-d1" style={{ background: 'var(--surface)', border: '1px solid var(--border-mid)', borderRadius: 8, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 20px', borderBottom: '1px solid var(--border)', background: 'var(--surface-2)' }}>
              ...
              <button onClick={handleCopy} style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 11, color: copied ? 'var(--green)' : 'var(--accent)', background: 'none', border: '1px solid', borderColor: copied ? 'rgba(74,222,128,0.3)' : 'rgba(45,212,191,0.3)', padding: '4px 12px', borderRadius: 4, cursor: 'pointer', transition: 'all 0.2s' }}>
          ...
          {actions.map((action, i) => (
            <div key={action.id} className={`reveal reveal-d${i + 1}`}>
              ...
              >
                ...
                <button style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 12, color: action.color, background: 'none', border: `1px solid ${action.color}`, borderRadius: 5, padding: '6px 14px', cursor: 'pointer', opacity: 0.8, transition: 'opacity 0.2s' }}>
              ...
              {activeAction === action.id && (
                <div style={{ marginTop: 12, background: 'var(--surface-2)', border: `1px solid ${action.color}`, borderRadius: 8, padding: 20 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button onClick={() => setActiveAction(null)} style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 12, background: action.color, color: '#000', border: 'none', padding: '7px 16px', borderRadius: 5, cursor: 'pointer', fontWeight: 600 }}>{action.dialog.confirm}</button>
                    <button onClick={() => setActiveAction(null)} style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 12, background: 'none', color: 'var(--muted)', border: '1px solid var(--border-mid)', padding: '7px 16px', borderRadius: 5, cursor: 'pointer' }}>{action.dialog.cancel}</button>
                  </div>
                </div>
              )}
            </div>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
        ...
        <div className="reveal reveal-d1" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16, borderTop: '1px solid var(--border)', paddingTop: 48 }}>
          {[
            ...
            { label: 'User Guide', value: 'Wiki', link: 'https://github.com/DebdootManna/SentinelShark/wiki/USER_GUIDE.md' },
            { label: 'Developer Guide', value: 'Wiki', link: 'https://github.com/DebdootManna/SentinelShark/wiki/DEVELOPER_GUIDE.md' },
    ...
    <footer style={{ borderTop: '1px solid var(--border)', padding: '40px 0' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
          {[['GitHub', 'https://github.com/DebdootManna/SentinelShark'], ['Documentation', 'https://github.com/DebdootManna/SentinelShark/wiki'], ['Architecture', 'https://github.com/DebdootManna/SentinelShark/wiki/ARCHITECTURE.md'], ['User Guide', 'https://github.com/DebdootManna/SentinelShark/wiki/USER_GUIDE.md']].map(([label, href]) => (
